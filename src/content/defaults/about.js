export default {
  hero: {
    overline: 'About Yali Labs',
    title: 'Building the future of AI in Africa.',
    paragraphs: [
  ...
  story: {
    ...
    valuesOverline: 'What we believe',
    values: [
  ...
  cta: {
    ...
    text: 'The people behind Yali Labs bring together expertise in artificial intelligence, data engineering, and business development.',
    buttonLabel: 'Meet the team',
    buttonHref: '/company/our-team',
  },
};
